    ...
    <ResponsiveScreen>
      ...
      <View style={{ gap: 14 }}>
        ...
        <View style={[styles.grid, isWide && styles.gridWide]}>
          ...
          <Pressable
            onPress={() =>
              router.push({ pathname: "/(caregiver)/teacher-content", params: { child_id: String(safeChildId) } })
            }
            style={({ pressed }) => [styles.actionCard, pressed && { opacity: 0.92 }]}
          >
            <Text style={styles.actionTitle}>Teacher Content</Text>
            <Text style={styles.actionDesc}>Turn songs and routines into visual cue cards.</Text>
          </Pressable>
